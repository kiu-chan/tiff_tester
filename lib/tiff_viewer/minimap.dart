...
/// Small overview of the whole page with a rectangle marking the area
/// currently visible in the main viewer (tap or drag on it to jump there),
/// drawn from [_TileEngine.overview] (cheap, always sized to the base
/// image's aspect ratio) rather than a full-resolution decode.
...
/// Minimap for the region-engine (non-tiled page) viewer: same behavior as
/// [_TiledMinimap], but reads live from a [_RegionEngine] instead.
class _RegionMinimap extends StatelessWidget {
  static const _boxSize = Size(140, 100);
  ...
  const _RegionMinimap({required this.engine, required this.controller, required this.viewportSize});
